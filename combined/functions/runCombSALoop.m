function runCombSALoop(user, imposter, probeSets, setType, monoRefs, ...
...
params.PA.blockLength = 250;
params.PA.absThresh = 1.25;
params.PA.tolerance = 0.5;
params.PA.note = 'Half weights for digraphs';

params.infl.type = 'decisionLevel';
params.infl.upMult = 1.001; % remember to remove breakpoint
params.infl.downMult = 0.8;
